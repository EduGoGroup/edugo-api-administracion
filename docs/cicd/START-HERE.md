# 🎯 COMIENZA AQUÍ - edugo-api-administracion
...
│ 📂 Ruta: /repos-separados/edugo-api-administracion/docs/cicd/ │
...
```
edugo-api-administracion/ (repositorio de código)
│
├── [módulos Go: handlers/, services/, repositories/]   ← Código fuente
...
**Prompt a usar:**
```
Continúa el trabajo de CI/CD en edugo-api-administracion desde donde quedó.
```
...
**Prompt a usar:**
```
Ejecuta FASE 1 del SPRINT-X en edugo-api-administracion.
```
...
2. **Verifica ubicación:**
   ```bash
   pwd
   # Debe contener: /edugo-api-administracion/docs/cicd
   ```
...
# Debe mostrar: .../edugo-api-administracion/docs/cicd/sprints/SPRINT-1-TASKS.md
